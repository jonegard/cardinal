...
public class LineDrawingEvent extends DrawingEvent
{
  private final static long serialVersionUID = 5098623980346782039L;
  ...
  public LineDrawingEvent(DrawingEventType type, Color color, float width, Point point1, Point point2)
  {
    super(type);
    if (color == null)
    {

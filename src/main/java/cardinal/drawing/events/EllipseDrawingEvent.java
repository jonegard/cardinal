...
public class EllipseDrawingEvent extends DrawingEvent
{
  ...
  public EllipseDrawingEvent(DrawingEventType type, Color color, float width, Point point1, Point point2)
  {
    super(type);
    if (color == null)
    {
